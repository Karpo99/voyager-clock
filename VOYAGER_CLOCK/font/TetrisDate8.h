#ifndef TETRIS_DATE8_H
#define TETRIS_DATE8_H

#include <Arduino.h>
#include <Adafruit_GFX.h>

namespace TetrisDate8 {

static const uint8_t CELL = 1;
static const uint8_t GLYPH_W = 6; // 5 pixels + 1 spacing
...
static const uint8_t DOT[GLYPH_H] = {0, 0, 0, 0, 0, 0b01100, 0b01100};
